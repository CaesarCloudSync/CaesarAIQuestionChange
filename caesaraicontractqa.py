...
class CaesarAIContractQA(object):
    ...
    def ask_question(self, 
                     ...
                     temperature=0, 
                     max_length=300, 
                     language="Spanish",changetoquestion=False):
        """
        ...
        if relevant_docs:
            ...
            if changetoquestion:
                prompt_template = """
                The Answer has to be in English language.
                Use the following pieces of context to apply the instruction at the end.
...
if __name__ == "__main__":
    # ********************************** EXAMPLE **********************************
    caesaraiqa = CaesarAIContractQA(data_text="""There are ad hoc backups.""")
